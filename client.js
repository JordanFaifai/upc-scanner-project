...
async function fetchAndProcessProduct(upc, fromScan) {
    ...
    if (product) {
        ...
        // WITH THIS LINE:
        renderProductInfo(null, upc); // Call renderProductInfo with null product and the UPC
        lastScannedCode = null; // Clear lastScannedCode as it's no longer a valid displayed product
        setupAccordions(); // Re-setup accordions to make the new sections collapsible
    }
}
